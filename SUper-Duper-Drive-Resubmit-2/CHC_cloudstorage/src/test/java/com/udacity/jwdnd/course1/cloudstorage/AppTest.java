...
//      Have used Thread.sleep as it will stop thread execution for few seconds and helps us to view the page for some duration.
...
//    ________ Credential Tests _______
    ...
    @Test
    public void createNoteTestTitleDesc()  {
        try{
